...
export const NeoclassicalMotionCartouche: React.FC<{ 
  ...
  <div 
    onClick={onClick}
    className={`relative group cursor-pointer w-full max-w-5xl xl:max-w-6xl 2xl:max-w-7xl mx-auto rounded-2xl sm:rounded-3xl px-4 sm:px-8 py-2.5 sm:py-3.5 transition-all duration-300 ${className}`}
  >
